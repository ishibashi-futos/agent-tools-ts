...
- [ ] [P1] worktreeの作成: git worktree を作成して、workspaceRoot を切り替えられる機能

## `edit` ファイル操作

- [x] apply_patch: ファイルを差分で書き換え
- [x] [P0] apply_patch の戻り値をvoidではなく、エージェントに正しく成功したことを返せるようにする
- [ ] create_file: ファイル作成
...
- [ ] [P1] ツールを単一バイナリとして公開できるようにする
- [ ] [P1] 監査ログ機能追加
- [x] [P0] `invoke`: toolのname, argumentsだけで `invoke` できるようにする
- [ ] [P1] 複数 `workspaceRoot` の管理
